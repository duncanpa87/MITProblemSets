...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for i,letter in enumerate(vowels_permutation):
            transpose_dict[lowercase_vowels[i]] = letter.lower()
            transpose_dict[uppercase_vowels[i]] = letter.upper()
    ...
    def decrypt_message(self):
        ...
        for perm in get_permutations('aeiou'):
            ...
            for word in self.apply_transpose(self.build_transpose_dict(perm)).split():
                ...
                if current_valid_words > most_valid_words:
                    most_valid_words = current_valid_words
                    best_perm = perm
...
if __name__ == '__main__':
    ...
    g = SubMessage("I like to eat eat eat ApPle AnD banana")
    m = g.apply_transpose(enc_dict)
    e = EncryptedSubMessage(m)
    print(e.get_message_text(), e.decrypt_message())
